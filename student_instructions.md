...
3. Start playing with Python! Please make sure to go throw all the [examples/test.ipynb](000_example.ipynb) to familiarize with the typical Python concepts that will be used during the course, but also to verify your installation. 
